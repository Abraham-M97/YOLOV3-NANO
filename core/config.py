...
# Set the class name
__C.YOLO.CLASSES                = "./data/classes/tiny.names"
__C.YOLO.ANCHORS                = "./data/anchors/dock_anchors.txt"
...
__C.TRAIN.ANNOT_PATH            = "./data/dataset/dock_train.txt"
...
__C.TEST.ANNOT_PATH             = "./data/dataset/dock_test.txt"
